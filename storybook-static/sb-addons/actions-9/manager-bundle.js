  ...
  function D(e, t) {
    ...
    if (e && t && (r = e.constructor) === t.constructor) {
      ...
      if (r === Set) {
        ...
        for (n of e)
          if (((o = n), (o && typeof o == 'object' && ((o = Ue(t, o)), !o)) || !t.has(o))) return !1
        return !0
      }
      if (r === Map) {
        if (e.size !== t.size) return !1
        for (n of e)
          if (
            ((o = n[0]), (o && typeof o == 'object' && ((o = Ue(t, o)), !o)) || !D(n[1], t.get(o)))
          )
            return !1
        return !0
      }
      ...
      if (!r || typeof e == 'object') {
        n = 0
        for (r in e)
          if ((je.call(e, r) && ++n && !je.call(t, r)) || !(r in t) || !D(e[r], t[r])) return !1
          ...
          let l = s.split('.'),
            c = (p, d, f) => {
              ...
              if (f === 0) X(p, t) && (E === K || E === Ge) && c(p, K, f + 1)
                ...
                for (let { name: m, data: y } of t(p)) X(y, t) && c(y, `${d}.${m}`, f + 1)
              else {
                let m = p[E]
                X(m, t) && c(m, `${d}.${E}`, f + 1)
              }
  ...
  var Mt = ({ rows: e, columns: t, rowsData: r }) => {
    ...
    zt = ({ data: e, columns: t }) => {
      let r = _('TableInspector'),
        ...
        l = S(() => {
          s(({ sortIndexColumn: m, sortAscending: y }) => ({
            sorted: !0,
            sortIndexColumn: !0,
            sortColumn: void 0,
            sortAscending: m ? !y : !0,
    ...
    Gt = ({ isCloseTag: e, data: t, expanded: r }) => {
      ...
      if (e)
        return a.createElement($e, { styles: n.htmlCloseTag, isChildNode: !0, tagName: t.tagName })
      switch (t.nodeType) {
