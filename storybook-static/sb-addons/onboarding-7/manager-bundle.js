            ...
            Zn(n, [
              ...
              },
              {
                ...
                value: function () {
                  var r = this,
                    o =
                      arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.target,
                    ...
                    if (Wt && et('status', K.PAUSED)) {
                      ...
                      this.callback(
                        D(
                          D({}, Nt),
                          {},
                          { index: o.index, lifecycle: _.COMPLETE, step: ne, type: Vt.STEP_AFTER }
                        )
                      )
                    }
                      ...
                      s ||
                        this.callback(
                          D(
                            D({}, Nt),
                            {},
                            { index: o.index, lifecycle: _.COMPLETE, step: Mt, type: Vt.STEP_AFTER }
                          )
                        ),
                        this.callback(
...
`
  ...
  function lw(t) {
    ...
    return (
      isNaN(t) &&
      kr(t) &&
      ((n = (e = t.match(Nn)) === null || e === void 0 ? void 0 : e.length) !== null && n !== void 0
        ? n
        : 0) +
  ...
  function hw(t, e, n) {
    var r = t.style || {},
      o = {}
    return (
      nm(o, r, t), Object.assign(o, dw(t, e, n)), t.transformValues && (o = t.transformValues(o)), o
    )
  }
  function mw(t, e, n) {
    var r = {},
      ...
      return (
                ...
                this.addEventListener('didUpdate', function (E) {
                  ...
                  if (
                    ...
                    !N && u.animationProgress === 0 && u.finishAnimation(),
                      u.isLead() &&
                        ((S = (O = u.options).onExitComplete) === null || S === void 0 || S.call(O))
                  u.targetLayout = X
                })
          }
        }),
        ...
        (a.prototype.setAnimationOrigin = function (s, l) {
          ...
          var m = Pt(),
            y = f?.isShared,
            E =
              (((c = this.getStack()) === null || c === void 0 ? void 0 : c.members.length) || 0) <=
              1,
...
export const Warning = {
  ...
  Ni.register('@storybook/addon-onboarding', async (t) => {
    ...
    t.once(ru, () => {
      if (
        !(
          t.getData('example-button--primary') || document.getElementById('example-button--primary')
        )
      ) {
        console.warn(
