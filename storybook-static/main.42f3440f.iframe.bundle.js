    ...
    './src lazy recursive ^\\.\\/.*$ include: (?:\\/src(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.tsx)$':
      function (module, __unused_webpack_exports, __webpack_require__) {
        var map = {
          ...
          './components/AddItemForm/AddItemForm.stories.tsx': [
            './src/components/AddItemForm/AddItemForm.stories.tsx',
            766,
            516,
            369,
          ],
          './components/EditableSpan/EditableSpan.stories': [
            './src/components/EditableSpan/EditableSpan.stories.tsx',
            766,
            298,
          ],
          './components/EditableSpan/EditableSpan.stories.tsx': [
            './src/components/EditableSpan/EditableSpan.stories.tsx',
            766,
            298,
          ],
