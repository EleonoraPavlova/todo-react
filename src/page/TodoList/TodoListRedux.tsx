...
import { FilterValuesType, TodolistDomainType, removeTodolistTC, updateTodolistTC } from 'reducers/todolistsSlice/todolistsSlice'
import { addTaskTC } from 'reducers/tasksSlice/tasksSlice'
...
export const TodoListRedux: React.FC<TodoListReduxProps> = memo(
  ({ demo = false, todolist, tasksForTodolist }) => {
