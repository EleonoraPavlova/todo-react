...
;(self.webpackChunktodo_react = self.webpackChunktodo_react || []).push([
  [202],
  {
    './node_modules/@storybook/components/dist/OverlayScrollbars-GZGLA7DL.mjs': function (
      ...
      function each(t2, n2) {
        if (isArrayLike(t2)) for (let o2 = 0; o2 < t2.length && !1 !== n2(t2[o2], o2, t2); o2++);
      ...
      var m,
        ...
        push = (t2, n2, o2) => (
          o2 || isString(n2) || !isArrayLike(n2) ? t2.push(n2) : Array.prototype.push.apply(t2, n2),
          t2
        ),
        from = (t2) => {
          let n2 = Array.from,
        ...
        assignDeep = (t2, n2, o2, s2, e2, c2, r2) => {
          ...
          return (
            ('object' != typeof t2 || isNull(t2)) && !isFunction(t2) && (t2 = {}),
            each(i2, (n3) => {
              each(keys(n3), (o3) => {
                let s3 = n3[o3]
                if (t2 === s3) return !0
                ...
                if (s3 && (isPlainObject(s3) || e3)) {
                  let n4 = t2[o3],
                    c3 = n4
                  e3 && !isArray(n4) ? (c3 = []) : !e3 && !isPlainObject(n4) && (c3 = {}),
        ...
        is = (t2, n2) => !!isElement(t2) && (s.matches || s.msMatchesSelector).call(t2, n2),
        ...
        liesBetween = (t2, n2, o2) => {
          let s2 = t2 && closest(t2, n2),
            ...
            c2 = closest(e2, n2) === s2
          return (
            !(!s2 || !e2) && (s2 === t2 || e2 === t2 || (c2 && closest(closest(t2, o2), n2) !== s2))
          )
        },
        before = (t2, n2, o2) => {
          if (o2 && t2) {
        ...
        jsAPI = (t2) => {
          if (isClient()) {
            ...
            return (
              hasOwnProperty(r, t2) ||
                (each(c, (o2) => ((n2 = n2 || window[o2 + firstLetterToUpper(t2)]), !n2)),
                (r[t2] = n2)),
              n2
            )
          }
        ...
        equal = (t2, n2, o2, s2) => {
          if (t2 && n2) {
            ...
            return (
              each(o2, (o3) => {
                ;(s2 ? s2(t2[o3]) : t2[o3]) !== (s2 ? s2(n2[o3]) : n2[o3]) && (e2 = !1)
              }),
              e2
            )
          }
        ...
        getCSSVal = (t2, n2, o2) => (null != n2 ? n2[o2] || n2.getPropertyValue(o2) : t2.style[o2]),
        setCSSVal = (t2, n2, o2) => {
          try {
            let { style: s2 } = t2
            isUndefined(s2[n2])
              ? s2.setProperty(n2, o2)
              : (s2[n2] = ((t2, n2) => (!w[t2.toLowerCase()] && isNumber(n2) ? `${n2}px` : n2))(
                  n2,
                  o2
                ))
          } catch {}
        ...
        getRtlScrollBehavior = (t2, n2) => {
          style(t2, { overflowX: 'hidden', overflowY: 'hidden', direction: 'rtl' }),
            scrollLeft(t2, 0)
            ...
            a2 = ((t2) => {
              ...
              try {
                n2 =
                  ...
                  'none' ===
                    window.getComputedStyle(t2, '::-webkit-scrollbar').getPropertyValue('display')
              } catch {}
              return o2(), n2
            })(o2),
        ...
        getPropByPath = (t2, n2) =>
          t2
            ? n2.split('.').reduce((t3, n3) => (t3 && hasOwnProperty(t3, n3) ? t3[n3] : void 0), t2)
            : void 0,
        ...
        createStructureSetupElements = (t2) => {
          let n2 = getEnvironment(),
            ...
            at2 = b3
              ? nt2
              : contents([ct2, et2, st2, ot2, nt2].find((t3) => !1 === elementIsGenerated(t3))),
            ut2 = k2 ? nt2 : ct2 || et2
          return [
            Q2,
            () => {
        ...
        createOverflowUpdateSegment = (t2, n2) => {
          ...
          return (t3, n3, i3) => {
            ...
            let [et2, ct2] = ot2,
              ...
              _t2 =
                (Z2 && J2 && (ft2.x || ft2.y)) || (Z2 && ft2.x && !ft2.y) || (J2 && ft2.y && !ft2.x)
            ...
            return (
              s2({ Ct: ht2, zt: { x: et2.w, y: et2.h }, Tt: { x: rt2.w, y: rt2.h }, Et: ft2 }),
            ...
            observerCallback = (e3, c3) => {
              ...
              if (
                ...
                l2.size > 0 &&
                  h2((t3) =>
                    from(l2).reduce(
                      (n3, o3) => (push(n3, find(t3, o3)), is(o3, t3) ? push(n3, o3) : n3),
                      []
                    )
                  ),
                n2)
        ...
        createSizeObserver = (t2, n2, o2) => {
          let { Bt: s2 = !1, Vt: e2 = !1 } = o2 || {},
            ...
            onSizeChangedCallbackProxy = (t3) => {
              ...
              if (o3) {
                ...
                ;(c3 = !o4 || !s3), (i3 = !domRectHasDimensions(o4) && s3), (a3 = !c3)
          ...
          return [
            ...
            () => {
              ...
              h2 && (addClass(l2, N), push(_2, on(l2, 'animationstart', h2, { C: !!u }))),
                ...
                ? ((t2, n2) => {
                    let o2,
                      ...
                      triggerOnTrinsicChangedCallback = (t3, o3) => {
                        if (t3) {
                          let s3 = c2(
                              ((t2) => 0 === t2.h || t2.isIntersecting || t2.intersectionRatio > 0)(
                                t3
                              )
                            ),
                            [, e3] = s3
            ...
            f3 = ((t2, n2) => {
              ...
              return (t3, n3, r3) => {
                let i3 = prepareUpdateHints(
                    assignDeep(
                      { gt: !1, xt: !1, yt: !1, vt: !1, At: !1, Lt: !1, It: !1, Ot: !1, wt: !1 },
                      n3
                    ),
                    {},
                    r3
        ...
        createRootClickStopPropagationEvents = (t2, n2) =>
          on(t2, 'mousedown', on.bind(0, n2, 'click', stopPropagation, { C: !0, $: !0 }), {
            $: !0,
          }),
            ...
            if (
              ...
              ((t2, n2, o2) => {
                let s2 = n2.scrollbars,
                  ...
                  { pointers: i2 } = s2
                return (
                  0 === e2 && c2 && s2[o2 ? 'dragScroll' : 'clickScroll'] && (i2 || []).includes(r2)
                )
              })(s3, t2, c3))
            ) {
          ...
          let { N: s2, L: e2 } = getEnvironment(),
            ...
            scrollbarStructureRefreshHandleLength = (t3, n3, o3) => {
              scrollbarsHandleStyle(t3, (t4) => {
                ...
                return [
                  ...
                  {
                    [o3 ? 'width' : 'height']:
                      `${(100 * getScrollbarHandleLengthRatio(s3, e3, o3, n3)).toFixed(3)}%`,
                  },
                ]
              })
            },
            scrollbarStructureRefreshHandleOffset = (t3, n3, o3) => {
              ...
              scrollbarsHandleStyle(t3, (t4) => {
                ...
                return [
                  e3,
                  { transform: i3 == i3 ? `translate${s3}(${(100 * i3).toFixed(3)}%)` : '' },
                ]
              })
            },
            b3 = [],
              ...
              (t3, s3, i3) => {
                let { At: u3, Lt: d3, It: f4, yt: _3 } = i3,
                  ...
                  setScrollbarVisibility = (t4, n3) => {
                    let o3 = 'visible' === $3 || ('auto' === $3 && 'scroll' === t4)
        ...
        A2 = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)((l2, c2) => {
          let { element: t2 = 'div', options: o2, events: a2, defer: i2, children: r2, ...u2 } = l2,
            ...
            [y2, d2] = ((l2) => {
              let { options: c2, events: t2, defer: o2 } = l2 || {},
                [a2, i2] = (0, react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(O2, []),
          ...
          return (
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              ...
              react__WEBPACK_IMPORTED_MODULE_0__.createElement('div', { ref: e2 }, r2)
            )
          )
        }),
